...
const ALL_REFERRALS = [
  { id: 1, name: 'Владимир', username: '@valodya_n6214', avatar: null },
  { id: 2, name: 'Николай', username: '@NiK332', avatar: null },
  { id: 3, name: 'Владимир', username: '@valodya_n6214', avatar: null },
  { id: 4, name: 'Владимир', username: '@valodya_n6214', avatar: null },
  { id: 5, name: 'Николай', username: '@NiK332', avatar: null },
  { id: 6, name: 'Николай', username: '@NiK332', avatar: null },
  { id: 7, name: 'Марина', username: '@marino4ka_228', avatar: null },
  { id: 8, name: 'Марина', username: '@marino4ka_228', avatar: null },
  { id: 9, name: 'Марина', username: '@marino4ka_228', avatar: null }
]
    ...
    <main className="w-full relative min-h-screen app-frame">
      ...
      <section className="px-4 pt-4 relative z-10">
          ...
          {ALL_REFERRALS.map((referral) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-white/70 text-xs">{referral.username}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-6 mb-4">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-medium">Ваши реферальные ссылки</span>
            </div>
        ...
        <div className="text-white/70 text-xs mb-8">
          Считаются только те аккаунты, которые посмотрели хотя бы одну серию.
        </div>
      </section>
    </main>
  )
